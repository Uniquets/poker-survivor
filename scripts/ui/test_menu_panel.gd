...
@onready var _btn_pool: Button = $Center/Panel/VBox/BtnAddPool
@onready var _btn_sort: Button = $Center/Panel/VBox/BtnSort
...
## 由 RunScene 调用：显示全屏菜单（不改变本节点 pause 行为，由场景树 paused 控制世界）
func show_menu() -> void:
	visible = true
